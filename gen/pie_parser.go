...
func pieParserInit() {
  ...
  staticData.serializedATN = []int32{
	...
	4, 1, 4, 1, 4, 1, 4, 1, 4, 1, 4, 3, 4, 103, 8, 4, 1, 4, 1, 4, 1, 4, 1, 
	4, 1, 4, 1, 4, 1, 4, 1, 4, 3, 4, 113, 8, 4, 1, 5, 1, 5, 1, 5, 1, 5, 1, 
	5, 5, 5, 120, 8, 5, 10, 5, 12, 5, 123, 9, 5, 3, 5, 125, 8, 5, 1, 5, 1, 
	5, 1, 6, 1, 6, 1, 6, 1, 6, 3, 6, 133, 8, 6, 1, 7, 1, 7, 1, 7, 1, 7, 5, 
	7, 139, 8, 7, 10, 7, 12, 7, 142, 9, 7, 1, 8, 1, 8, 1, 8, 1, 8, 5, 8, 148, 
	8, 8, 10, 8, 12, 8, 151, 9, 8, 1, 9, 1, 9, 1, 9, 1, 9, 1, 9, 1, 9, 1, 9, 
	1, 9, 1, 9, 1, 9, 1, 9, 3, 9, 164, 8, 9, 1, 10, 1, 10, 1, 10, 1, 11, 1, 
	...
	0, 0, 124, 116, 1, 0, 0, 0, 124, 125, 1, 0, 0, 0, 125, 126, 1, 0, 0, 0, 
	126, 127, 5, 5, 0, 0, 127, 11, 1, 0, 0, 0, 128, 132, 3, 14, 7, 0, 129, 
	130, 3, 30, 15, 0, 130, 131, 3, 14, 7, 0, 131, 133, 1, 0, 0, 0, 132, 129, 
	1, 0, 0, 0, 132, 133, 1, 0, 0, 0, 133, 13, 1, 0, 0, 0, 134, 140, 3, 16, 
	8, 0, 135, 136, 3, 28, 14, 0, 136, 137, 3, 16, 8, 0, 137, 139, 1, 0, 0, 
	0, 138, 135, 1, 0, 0, 0, 139, 142, 1, 0, 0, 0, 140, 138, 1, 0, 0, 0, 140, 
	141, 1, 0, 0, 0, 141, 15, 1, 0, 0, 0, 142, 140, 1, 0, 0, 0, 143, 149, 3, 
...
type AssignementStatementContext struct {
	StatementContext
}

func NewAssignementStatementContext(parser antlr.Parser, ctx antlr.ParserRuleContext) *AssignementStatementContext {
	var p = new(AssignementStatementContext)
...
func (s *AssignementStatementContext) GetRuleContext() antlr.RuleContext {
	return s
}

func (s *AssignementStatementContext) Qid() IQidContext {
	var t antlr.RuleContext;
	for _, ctx := range s.GetChildren() {
...
func (s *AssignementStatementContext) ASSIGN() antlr.TerminalNode {
	return s.GetToken(PieParserASSIGN, 0)
}

func (s *AssignementStatementContext) Expr() IExprContext {
	var t antlr.RuleContext;
	for _, ctx := range s.GetChildren() {
		if _, ok := ctx.(IExprContext); ok {
			t = ctx.(antlr.RuleContext);
...
func (s *AssignementStatementContext) NL() antlr.TerminalNode {
	return s.GetToken(PieParserNL, 0)
}


func (s *AssignementStatementContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case PieVisitor:
		return t.VisitAssignementStatement(s)
...
func (p *PieParser) Statement() (localctx IStatementContext) {
	...
	case 2:
		localctx = NewAssignementStatementContext(p, localctx)
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(84)
			p.Qid()
